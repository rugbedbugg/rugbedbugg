<!--
  ...
  (Departure Mono font + dithered headshot embedded; CSS animations run inside
  GitHub's <img> rendering). Live stats, languages, the contribution calendar,
  and the rotating quote are fetched at build time.
